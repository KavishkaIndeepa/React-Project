...
export class Products extends Component<ProductsProps, ProductState> {
    ...
    render() {
        ...
        return (
            <div className={"w-52 h-64  mr-2 mb-5 justify-center items-center border-gray-800 border-[1px] hover:bg-blue-600"}>
                <div>
                ...
                <div className={"flex"}>
                    ...
                    <div>
                        <h3 className={"text-secondary text-[12px] pl-2 hover:text-white"}> {data.name} </h3>
                    </div>
